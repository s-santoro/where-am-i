...
public class LocationController extends Controller {
    ...
    @Inject
    public LocationController(LocationService locationService, HttpExecutionContext ec) {
    ...
    @SuppressWarnings("Duplicates")
    public CompletionStage<Result> getLocation(long id) {
    ...
    public CompletionStage<Result> createNewLocation() {
        ...
        return locationService.add(locationToPersist)
                .thenApplyAsync(location -> ok(Json.toJson(location)), ec.current());
    }
