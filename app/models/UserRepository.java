...
public class UserRepository
{
	...
	@Inject public UserRepository(JPAApi jpaApi,
	...
	private User delete(EntityManager em, Long id)
	{
		...
		Stream<Session> sessionsFiltered = sessions
				.filter(session -> session.getUser_fk() == id);
		sessionsFiltered.forEach(
				session -> sessionRepository.delete(em, session.getId()));
